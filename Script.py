...
➤ 📷 Qʀ ᴄᴏᴅᴇ → <a href='https://i.ibb.co/Q7JBqkWy/photo-2025-07-30-17-01-20-7532931690071588888.jpg'>ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ꜱᴄᴀɴ</a>  
➤ 💸 ᴜᴘɪ ɪᴅ → <code>7204183600-2@ybl</code>
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """ғɪʟᴍ ɴᴀᴍᴇ : <code>{file_name}</code>
    
ғɪʟᴇ sɪᴢᴇ : <i>{file_size}</i>

<b>⚡ [ᴊᴏɪɴ ᴏᴜʀ ғɪʟᴍ ɢʀᴏᴜᴘ](https://t.me/vk_moviegroup2) ⚡</b>"""
...
•─────•─────────•─────•
🏷️ <a href='https://t.me/vk_moviegroup2'>ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ᴘʀᴏᴏꜰ</a>
...
💳 ᴜᴘɪ ɪᴅ - <code>v.thouseef@ptyes</code>
...
💸 ᴜᴘɪ ɪᴅ → <code>v.thouseef@ptyes</code>  
📷 ǫʀ ᴄᴏᴅᴇ → <a href='https://i.ibb.co/Q7JBqkWy/photo-2025-07-30-17-01-20-7532931690071588888.jpg'>ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ꜱᴄᴀɴ</a>  
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/Vk_Thouseef'>Owner</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
This Is An Open-Source Project. But Selling The Source Code Is Strictly Prohibited.\n
ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<a href=https://t.me/Vk_Thouseef>Vk_Thouseef</a>\n """
